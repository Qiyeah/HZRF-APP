            ...
            switch (msg.what) {
                case 1:
                   ...
                   /* mNotification.contentView.setTextViewText(R.id.content_view_text1, name + " " + result + "%");
                    ...
                    dialog.incrementProgressBy(result);
                    dialog.show();
...
//        dialog.setMessage("这是一个水平进度条");
        ...
        // dialog.setProgressDrawable(mContext1.getDrawable(R.drawable.fj_icon));
