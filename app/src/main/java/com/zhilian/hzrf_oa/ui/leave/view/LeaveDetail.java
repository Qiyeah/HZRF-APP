    ...
    private void initView() {
        ...
        fjListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long arg3) {
                ...
                downLoad.context = LeaveDetail.this;
                downLoad.name = url;
...
//                                    }
            ...
            public void run() {
                ...
                JsonRequest jsonRequest = new JsonStringRequest(Request.Method.POST, url, postData,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(LeaveDetail.this, response, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                       //
                        Toast.makeText(LeaveDetail.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
                requestQueue.add(jsonRequest);
                                ...
                                try {
                                    ...
                                    if (type.equals("9")) {
                                        ...
                                        for (int i = 0; i < list.size(); i++) {
                                            ...
                                            tempButton = new RadioButton(LeaveDetail.this);
            ...
            new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (!response.equals(bc.ERROR)) {
                        ...
                        selectmanAdapter = new SelectmanAdapter(selectmenlist, LeaveDetail.this);
                        mansListview.setAdapter(selectmanAdapter);
                    } else {
                        new TimeOutException().reLogin(getApplicationContext(), new ITimeOutException.CallBack() {
                            @Override
    ...
    public void selectman(String operation1) {
        ...
        if (StrKit.notBlank(json.getOpinionfield()) && StrKit.isBlank(tempopinion)) {
            Toast.makeText(LeaveDetail.this, "请填写意见!", Toast.LENGTH_SHORT).show();
        } else {
            new Thread() {
                public void run() {
                    try {
...
//           LogUtil.e("opinion","opinion = "+opinionStr);
            ...
            arrayAdapter = new ArrayAdapter<String>(LeaveDetail.this, android.R.layout.simple_spinner_item, opinions);
        ...
        public void onClick(View v) {
            ...
            if (atype.equals("3")) {//环节类型 3为结束 实现完成操作
                ...
                if (bc.getItem_id() != null) {
                    ...
                    if (Common.judgeNet(LeaveDetail.this)) {
                        Fasong();
                        if (StrKit.isBlank(bc.getNexttype()) ? false : bc.getNexttype().equals("toast")) {
                            builder.setTitle("下一环节处理人");
                        }
                    } else {
                        Toast.makeText(LeaveDetail.this, "请用新数据进行测试~", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (checked_id != null) {
                                ...
                                Toast.makeText(LeaveDetail.this, "请选择！", Toast.LENGTH_SHORT).show();
                            }
