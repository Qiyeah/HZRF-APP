 ...
 * 发文的service
 */
public class DocsendService extends Service {
	public static final String ACTION = "com.zhilian.service.DocsendService";
	...
	private void initNotifiManager(String projectName, String activeName, int id) {
		...
		Intent intent = new Intent(this, DocsendDetail.class);
		...
		mBuilder.setContentTitle("待办发文：" + projectName)// 标题
